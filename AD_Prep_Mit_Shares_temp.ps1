...
# Weitere Standorte anlegen

$abfrage = Read-Host "Möchten Sie weitere Standorte anlegen? J für Ja, N für Nein." 

while (($abfrage = Read-Host "Möchten Sie weitere Standorte anlegen? J für Ja, N für Nein.") -eq "J")
    {
    $standort = Read-Host "Geben Sie den Standortnamen ein."
